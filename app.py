...
APP_VERSION = "5.12.3 — Adaptive Reference Fidelity + Motion Physics + Hook Engine + Emotion Performance + Hard Continuity"
...
12. JANGAN berasumsi jumlah atau jenis subjek. Deteksi SEMUA subjek yang terlihat dan relevan di seluruh reference: manusia, hewan, kendaraan hidup/bergerak, dan subjek lain. Jangan membuang supporting subject hanya karena bukan protagonis.
13. Tentukan peran setiap subjek berdasarkan reference: protagonist, co-protagonist, supporting subject, reaction subject, atau background. Jika subjek pendukung berkontribusi pada humor, sebab-akibat, emosi, atau payoff, statusnya WAJIB dipertahankan.
14. Bedakan SUBJECTS dari OBJECTS. Catat semua objek yang relevan terhadap aksi, blocking, komedi, atau kontinuitas; objek background yang tidak relevan boleh masuk sebagai environment/background.
15. Analisis spatial layout secara eksplisit: posisi kiri/kanan/tengah, depan/belakang, kursi/ruang, jarak relatif, orientasi tubuh, hubungan antar-subjek dan objek, serta bagian frame yang harus tetap terlihat.
16. Analisis camera composition secara eksplisit: posisi kamera, tinggi, arah pandang, framing, field of view/wide-vs-close, perspektif/lensa, camera movement, dan coverage. Jika beberapa subjek penting harus terlihat bersamaan, kamera WAJIB mempertahankan framing yang memungkinkan semuanya terbaca.
17. Analisis temporal secara menyeluruh. Catat kapan subjek/objek terlihat, masuk/keluar frame, bergerak, bereaksi, atau berubah keadaan. Jangan hanya menganalisis satu frame pembuka.
18. Pertahankan hubungan komedi/emosi antar-subjek. Contoh: satu subjek panik sementara subjek lain santai adalah bagian dari mekanisme humor dan tidak boleh diringkas menjadi satu karakter saja.
19. ANALISIS PERFORMANCE, bukan hanya deskripsi. Untuk setiap subjek, termasuk protagonist, co-protagonist, supporting, reaction, dan background yang terlihat/relevan, jelaskan perubahan emosi yang terlihat, intensitas 1-5, pemicu, facial performance, body language, head/gaze, movement quality, micro-reactions, dan timing relatif terhadap aksi. Jangan menulis "terlihat panik" tanpa menjelaskan tanda visual yang membuat panik terbaca.
20. SUBJECT PERFORMANCE COVERAGE — ABSOLUTE: untuk SETIAP item di subject_roster, buat TEPAT SATU item di subject_emotion_profiles dengan subject_id yang sama. Jangan hanya memberi contoh S1. Jika ada S1, S2, S3, dst., semuanya WAJIB mempunyai profile masing-masing. Supporting/reaction/background juga wajib mendapat profile, walaupun reaction-nya kecil. Array profile harus mencakup seluruh subject_id di subject_roster.
21. Untuk subject yang wajahnya tidak terlihat, jangan mengarang detail wajah; gunakan body language, head/gaze, movement quality, attention target, dan micro-reaction yang memang dapat terlihat.
22. Bangun EMOTION TIMELINE yang mengikuti sebab-akibat fisik/cerita. Emosi tidak boleh berubah karena timer arbitrer; perubahan emosi harus dipicu oleh kejadian yang terlihat atau informasi yang diterima subjek.
21. Gunakan REACTION HIERARCHY: primary reaction, secondary reaction, tertiary/background reaction. Subjek tidak boleh semuanya bereaksi identik pada saat yang sama kecuali referensi memang demikian.
22. Lacak GAZE/ATTENTION: apa yang dilihat setiap subjek sebelum, saat, dan sesudah perubahan emosi.
23. Pecah performance menjadi FACE + HEAD + BODY + HANDS/PAWS + GAZE + MOVEMENT QUALITY jika bagian tersebut relevan dan terlihat.
24. Analisis CAUSE → EMOTION → PERFORMANCE → CONSEQUENCE untuk beat penting.
25. Analisis CURIOSITY GAP dan retention beats: apa yang diketahui penonton, apa yang belum diketahui, sinyal bahaya/kejutan, delay sebelum payoff, escalation, reaction, dan payoff. Jangan membocorkan payoff terlalu cepat.
26. Untuk remix, pertahankan fungsi emosional dan pacing logic reference, tetapi boleh meningkatkan keterbacaan performance, curiosity, escalation, dan reaction selama tidak merusak continuity.
27. Untuk tiap scene target, sediakan emotional start state, trigger, peak/shift, end state, dan performance cues yang dapat langsung diterjemahkan ke prompt video.
28. Untuk scene dengan beberapa subjek, tentukan siapa yang memimpin emosi, siapa yang terlambat menyadari, siapa yang menjadi contrast/comedic foil, dan siapa yang hanya memberi micro-reaction.
29. Untuk remix Tale Of Paw, Milo tetap menjadi identitas channel. Jika reference memiliki protagonis non-Milo, petakan fungsi/peran protagonis tersebut ke Milo, tetapi pertahankan subjek pendukung lain sesuai hasil deteksi reference dan ubah identitas/penampilan mereka secara original. Jika reference memang memiliki Milo, pertahankan Milo.
30. REFERENCE FIDELITY ENGINE — ABSOLUTE: video asli adalah sumber kebenaran temporal utama. Gunakan video + keyframe bertimestamp untuk memeriksa perubahan antar-waktu, bukan hanya frame pembuka. Untuk setiap beat penting, catat bukti visual yang berubah: posisi kamera, posisi subjek, arah gerak, kecepatan relatif, momentum, reaksi tubuh, status prop, sumber efek lingkungan, dan hasil akhir.
31. MOTION / PHYSICS MAP — WAJIB: jika kendaraan bergerak, jelaskan arah gerak kendaraan, gerak relatif background, gerak tubuh akibat percepatan/belokan, kontak roda dengan permukaan, dan asal efek debu/kotoran. Efek lingkungan harus punya sumber spatial yang jelas dan tidak boleh muncul jauh dari sumbernya tanpa mekanisme visual.
32. ACTION-CRITICAL PROP LOCK — WAJIB: tandai semua objek yang sedang digigit, dipegang, ditarik, diinjak, dipakai, atau menjadi pemicu aksi sebagai action-critical_prop. Catat owner/subjek, posisi relatif, status, kapan berubah, dan kondisi yang dilarang (misalnya tiba-tiba hilang).
33. CAMERA FIDELITY — WAJIB: bedakan camera position, camera height, distance, angle, framing, perspective, dan camera movement. Jangan menyamakan "inside a car" dengan satu kamera generik. Catat hubungan kamera terhadap steering wheel, kursi, pintu, jendela, dashboard, dan subjek.
34. HOOK MECHANICS — WAJIB: identifikasi mengapa 1-3 detik pertama menarik, apa visual anomaly-nya, siapa yang menjadi pusat perhatian, apa curiosity gap-nya, sinyal eskalasi apa yang muncul, dan kapan payoff dibayar. Pertahankan mekanisme hook dalam remix walaupun identitas, setting detail, warna, atau execution berubah.
35. PAYOFF FIDELITY — WAJIB: analisis kondisi visual tepat sebelum payoff dan tepat setelah payoff. Jangan hanya menulis "ending lucu". Catat physical state, emotional state, camera state, dust/debris/environment state, dan reaksi protagonis setelah kekacauan.
36. REMIX ENHANCEMENT — WAJIB: buat rencana peningkatan daya tarik yang mempertahankan CAUSAL CORE reference. Boleh membuat lebih lucu, absurd, chaotic, expressive, curiosity-driven, atau reaction-heavy, tetapi tidak boleh menghapus sebab-akibat, menghilangkan action-critical prop, merusak geography, atau membuat efek fisik tanpa sumber. Tingkatkan execution, bukan mengganti mekanisme yang membuat reference bekerja.
37. SCENE COVERAGE AUDIT — setiap target scene harus menunjuk beat/kejadian reference yang menjadi sumbernya, elemen hook yang dipertahankan, motion cue yang dipertahankan, emotional cue yang dipertahankan, action-critical prop yang dipertahankan, dan payoff/curiosity yang sedang dibangun.
38. ENDING LOCK — jika reference berakhir dengan kecelakaan komedi non-grafis seperti kendaraan berhenti/nyungsep dan debu beterbangan, pertahankan fungsi visual tersebut sebagai payoff. Protagonis harus memiliki reaksi yang kontras dan terbaca sesuai reference/remix plan, bukan otomatis panik jika karakter memang cue-nya cuek/sombong.
20. Properti biasa dan lingkungan yang tidak berbahaya harus dipertahankan secara visual. Untuk elemen berbahaya, pertahankan fungsi dramatis/komedinya tanpa detail operasional dan buat representasinya aman.
21. Jangan mengubah lokasi, geografi, jumlah subjek penting, atau komposisi hanya agar prompt terlihat lebih sinematik.
22. Semua nilai JSON berbahasa Indonesia.
...
{{
  ...
  "emotion_performance_analysis": {{
    "emotional_arc_global": ["relaxed", "serious", "tense", "panic", "relief"],
  ...
  "reference_fidelity": {{
    ...
    "subject_geography": ["..."],
    "motion_physics_map": [
      {{"beat":1,"vehicle_motion":"...","background_motion":"...","subject_motion":"...","effect_source":"...","effect_direction":"..."}}
    ],
...
2A. TEMPORAL WINDOW LOCK: untuk target scene 8 detik per scene, Scene N harus mengambil kejadian yang terjadi pada jendela referensi sekitar {(scene_number - 1) * 8:.1f}s–{scene_number * 8:.1f}s, lalu menyesuaikan hanya jika beat referensi benar-benar melintasi batas tersebut. Jangan memindahkan payoff Scene 2 ke Scene 1 atau sebaliknya.
...
13. UNTUK SCENE 2+: screenshot bridge adalah sumber kebenaran visual pada titik sambungan.
14. Buat field 'continuity_bridge' berdasarkan APA YANG BENAR-BENAR TERLIHAT pada screenshot, bukan tebakan dari storyboard.
15. 'start_state' Scene 2+ HARUS mencerminkan continuity_bridge. Jangan memperlebar kamera, mengubah framing, memindahkan subjek, mengganti ukuran relatif, atau menambahkan subjek baru pada frame pembuka kecuali perubahan itu benar-benar terlihat pada screenshot.
16. Pisahkan 'locked_at_opening' dari 'allowed_transition'. Perubahan baru hanya boleh dimulai setelah opening hold/establishing beat yang sangat singkat.
17. Jika screenshot memperlihatkan beberapa subjek, jangan menghilangkan subjek tersebut dari frame pembuka hanya demi komposisi yang lebih mudah.
18. PERFORMANCE WAJIB terbaca secara visual. Jangan hanya menulis label emosi seperti "panik" atau "takut"; tentukan cue wajah, kepala, pandangan, tubuh, tangan/paws, dan kualitas gerak yang membuat emosi terbaca.
19. Emosi berubah karena trigger/aksi yang jelas, bukan karena timer arbitrer. Gunakan pola CAUSE → EMOTION → PERFORMANCE → CONSEQUENCE.
20. Pertahankan reaction hierarchy dan emotional contrast antar-subjek. Tidak semua subjek boleh bereaksi sama pada waktu yang sama kecuali reference memang demikian.
21. Gunakan curiosity gap dan escalation jika ada pada reference/remix plan: sinyal → delay → escalation → reaction → payoff. Jangan reveal payoff terlalu awal.
22. END STATE harus menyimpan keadaan emosional dan perhatian subjek yang akan menjadi titik awal Scene berikutnya.
23. REFERENCE FIDELITY: jangan hanya menyalin nouns. Pertahankan mekanisme visual yang membuat reference bekerja: camera geography, motion vectors, physical cause/effect, action-critical props, emotional contrast, hook mechanics, escalation, dan payoff.
24. MOTION PHYSICS LOCK: setiap efek debu/kotoran/gerakan lingkungan harus berasal dari sumber yang terlihat dan mengikuti arah gerak yang masuk akal. Jangan menaruh debu di ujung frame tanpa hubungan spatial dengan kendaraan/roda/permukaan.
25. ACTION-CRITICAL PROP LOCK: objek yang sedang digigit/dipegang/dipakai harus tetap berada pada subjek dan berubah hanya melalui aksi yang terlihat. Dilarang tiba-tiba hilang.
26. REMIX ENHANCEMENT: buat execution lebih lucu, absurd, kacau, expressive, atau curiosity-driven sesuai remix_strategy, tetapi jangan mengubah causal core atau payoff logic.
27. HOOK MUST SURVIVE: 1-3 detik awal harus punya attention anchor + anomaly + unanswered question/signal. Jangan membuka scene dengan komposisi generik yang menghilangkan hook.
28. PERFORMANCE CONTRAST: jika protagonis cue-nya percaya diri/sombong sementara subject lain panik, pertahankan kontras itu. Setelah payoff, protagonis boleh tetap cuek/puas/tidak merasa bersalah jika itu fungsi komedi reference.
...
- Preserve the actual camera geography: do not substitute a generic wide shot for an inside-cabin/seat-level perspective when that perspective is part of the hook.
...
- Remix only by enhancing performance, escalation, absurdity, reaction contrast, curiosity, or safe visual comedy after the locked opening; do not replace the causal core.
